                    ...
                    <div class="iq-card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-left ml-3">
                                ...
                                <h5 class="">Số lượng sản phẩm bán</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="iq-card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-left ml-3">
                                ...
                                <h5 class="">Số lượng sản phẩm đến tay khách hàng</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between align-items-center">
                        <div class="iq-header-title">
                            <h4 class="card-title mb-0">Sản phẩm bán nhiều nhất</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                            ...
                            <li>
                                <?php
                                    foreach ($thongke as $tk) {
                                        extract($tk);
                                        echo '                                <div class="iq-details mb-2">
                                        <span class="title">'.$tensanpham.'</span>
                                        <div class="percentage float-right text-primary">'.$soluongban.'<span>%</span></div>
                                        <div class="iq-progress-bar-linear d-inline-block w-100">
                                            <div class="iq-progress-bar iq-bg-primary">
                                                <span class="bg-primary" data-percent="'.$soluongban.'"></span>
                                            </div>
                                        </div>
                                    </div>';
                                    }
